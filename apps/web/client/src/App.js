...
function App() {
  ...
  const cognyteDailyPlan = [
    ...
    { dayNumber: 7, title: 'HTTP, RxJS & Mock #1', focus: 'Angular integration patterns then full mock loop', tasks: ['Day 7 question set (Q67-Q77, Q264-Q285)', '45m technical mock', '30m coding', '15m behavioral'], verify: 'Weakness backlog created with next-step fixes.' },
  ...
  const dayByDayQuestionPlan = [
    ...
    { day: 7, focus: 'Angular HttpClient + RxJS (core + deep dive)', questions: 'Q67-Q77, Q264-Q285' },
