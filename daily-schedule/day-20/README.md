# Day 20: Study Plan (Rebalanced for Junior Fullstack)

## Level: Level 2: Solid Foundation | Week: 3

## 🎯 Priority Distribution

**Core Topics (70-80% of time)**: 20 topics - Essential for junior fullstack interviews  
**Extra Topics (20-30% of time)**: 1 topics - For higher acceptance in hightech companies
...
### 📚 CORE TOPICS - Focus Here First (20 topics)


#### Frontend

- [ ] 🔥 **Javascript** (CRITICAL)
  - Path: `../../frontend/javascript/questions.md`

- [ ] 🔥 **React** (CRITICAL)
  - Path: `../../frontend/react/questions.md`

- [ ] 📌 **Spa Ssr Ssg** (MEDIUM)
  - Path: `../../frontend/spa-ssr-ssg/questions.md`


#### Backend

- [ ] 🔥 **Nodejs** (CRITICAL)
  - Path: `../../backend/nodejs/questions.md`

- [ ] 📌 **Queues** (LOW)
  - Path: `../../backend/queues/questions.md`


#### APIs

- [ ] 🔥 **Rest** (CRITICAL)
  - Path: `../../apis/rest/questions.md`

- [ ] ⭐ **Http** (HIGH)
  - Path: `../../apis/http/questions.md`

- [ ] 📌 **Ajax** (LOW)
  - Path: `../../apis/ajax/questions.md`


#### Databases

- [ ] 📌 **Sharding Replication Caching** (MEDIUM)
  - Path: `../../databases/sharding-replication-caching/questions.md`


#### Architecture

- [ ] ⭐ **Mvc** (HIGH)
  - Path: `../../architecture/mvc/questions.md`

- [ ] 🔥 **System Design** (CRITICAL)
  - Path: `../../architecture/system-design/questions.md`

- [ ] 📌 **Onion Architecture** (LOW)
  - Path: `../../architecture/onion-architecture/questions.md`

- [ ] 📌 **Design Patterns** (MEDIUM)
  - Path: `../../architecture/design-patterns/questions.md`
...
- [ ] 📌 **Adapter** (LOW)
  - Path: `../../design-patterns/structural/adapter/questions.md`


#### Algorithms

- [ ] 🔥 **Logic Questions** (CRITICAL)
...
- [ ] ⭐ **Time Complexity** (HIGH)
  - Path: `../../algorithms/time-complexity/questions.md`

- [ ] ⭐ **Binary Trees** (HIGH)
  - Path: `../../algorithms/binary-trees/questions.md`


### ⚡ EXTRA TOPICS - For Higher Acceptance (1 topics)
...
### Core Topics: 70-80% of time (20 topics)
...
### Extra Topics: 20-30% of time (1 topics)
