# Day 23: Study Plan (Rebalanced for Junior Fullstack)
...
- [ ] 📌 **Integrations** (LOW)
  - Path: `../../backend/integrations/questions.md`
...
- [ ] 📌 **Application Layers** (MEDIUM)
  - Path: `../../architecture/application-layers/questions.md`
