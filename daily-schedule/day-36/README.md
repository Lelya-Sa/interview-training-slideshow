# Day 36: Study Plan (Rebalanced for Junior Fullstack)

## Level: Level 3: Intermediate Mastery | Week: 6

## 🎯 Priority Distribution

**Core Topics (70-80% of time)**: 15 topics - Essential for junior fullstack interviews  
**Extra Topics (20-30% of time)**: 3 topics - For higher acceptance in hightech companies
...
### 📚 CORE TOPICS - Focus Here First (15 topics)
...
### ⚡ EXTRA TOPICS - For Higher Acceptance (3 topics)
...
- [ ] **Docker** (LOW)
  - Path: `../../devops/docker/questions.md`


## 📊 Time Allocation (Recommended)

### Core Topics: 70-80% of time (15 topics)
...
### Extra Topics: 20-30% of time (3 topics)
