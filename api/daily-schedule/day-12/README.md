# Day 12: Study Plan (Rebalanced for Junior Fullstack)

## Level: Level 1: Interview-Ready Basics | Week: 2

## 🎯 Priority Distribution

**Core Topics (70-80% of time)**: 14 topics - Essential for junior fullstack interviews  
**Extra Topics (20-30% of time)**: 4 topics - For higher acceptance in hightech companies
...
### 📚 CORE TOPICS - Focus Here First (14 topics)
...
### ⚡ EXTRA TOPICS - For Higher Acceptance (4 topics)
...
- [ ] **Cicd** (LOW)
  - Path: `../../devops/cicd/questions.md`


## 📊 Time Allocation (Recommended)

### Core Topics: 70-80% of time (14 topics)
...
### Extra Topics: 20-30% of time (4 topics)
