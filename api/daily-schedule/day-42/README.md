# Day 42: Study Plan (Rebalanced for Junior Fullstack)

## Level: Level 3: Intermediate Mastery | Week: 6

## 🎯 Priority Distribution

**Core Topics (70-80% of time)**: 8 topics - Essential for junior fullstack interviews  
...
### 📚 CORE TOPICS - Focus Here First (8 topics)
...
- [ ] **Openid** (LOW)
  - Path: `../../security/openid/questions.md`

- [ ] **Kubernetes** (LOW)
  - Path: `../../devops/kubernetes/questions.md`

- [ ] **Observability** (LOW)
  - Path: `../../devops/observability/questions.md`


## 📊 Time Allocation (Recommended)

### Core Topics: 70-80% of time (8 topics)
